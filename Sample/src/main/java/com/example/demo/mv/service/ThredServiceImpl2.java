...
@WebListener
@Slf4j
public class ThredServiceImpl2 implements ThreadService, ServletContextListener, Runnable {
...
//        		try {this.thread.yield(); } catch (InterruptedException e1) {log.error(e1.toString());} // join을 실행하면 멈춘다(다음 Line으로 넘어가지 않음 )
